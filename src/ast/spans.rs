...
impl Spanned for SetExpr {
    fn span(&self) -> Span {
        match self {
            ...
            SetExpr::Call(statement) => statement.span(),
        }
    }
}
...
impl Spanned for Statement {
    fn span(&self) -> Span {
        match self {
            ...
            Statement::CreateTaskClone { .. } => Span::empty(),
            ...
            Statement::AlterPipe { .. } => Span::empty(),
            ...
            Statement::CreatePasswordPolicy { .. } => Span::empty(),
            Statement::AlterPasswordPolicy { .. } => Span::empty(),
            Statement::DropPasswordPolicy { .. } => Span::empty(),
            Statement::DescribePasswordPolicy { .. } => Span::empty(),
            Statement::ShowPasswordPolicies { .. } => Span::empty(),
            Statement::CreateSemanticView { .. } => Span::empty(),
            Statement::AlterSemanticView { .. } => Span::empty(),
            ...
            Statement::DescribeSessionPolicy { .. } => Span::empty(),
            Statement::ShowSessionPolicies { .. } => Span::empty(),
            Statement::CreateAuthenticationPolicy { .. } => Span::empty(),
            Statement::AlterAuthenticationPolicy { .. } => Span::empty(),
            Statement::DropAuthenticationPolicy { .. } => Span::empty(),
            Statement::DescribeAuthenticationPolicy { .. } => Span::empty(),
            Statement::ShowAuthenticationPolicies { .. } => Span::empty(),
            Statement::CreateBackupPolicy { .. } => Span::empty(),
            Statement::AlterBackupPolicy { .. } => Span::empty(),
            Statement::DropBackupPolicy { .. } => Span::empty(),
            Statement::DescribeBackupPolicy { .. } => Span::empty(),
            Statement::ShowBackupPolicies { .. } => Span::empty(),
            Statement::CreateNetworkRule { .. } => Span::empty(),
            Statement::AlterNetworkRule { .. } => Span::empty(),
            Statement::DropNetworkRule { .. } => Span::empty(),
            Statement::DescribeNetworkRule { .. } => Span::empty(),
            Statement::ShowNetworkRules { .. } => Span::empty(),
            ...
            Statement::CreateStorageIntegration { .. } => Span::empty(),
            Statement::AlterStorageIntegration { .. } => Span::empty(),
            Statement::DropStorageIntegration { .. } => Span::empty(),
            Statement::DescribeStorageIntegration { .. } => Span::empty(),
            Statement::ShowStorageIntegrations { .. } => Span::empty(),
            Statement::CreateApiIntegration { .. } => Span::empty(),
            Statement::AlterApiIntegration { .. } => Span::empty(),
            ...
            Statement::CreateSecurityIntegration { .. } => Span::empty(),
            Statement::AlterSecurityIntegration { .. } => Span::empty(),
            Statement::DropSecurityIntegration { .. } => Span::empty(),
            Statement::DescribeSecurityIntegration { .. } => Span::empty(),
            Statement::ShowSecurityIntegrations { .. } => Span::empty(),
            Statement::CreateNotificationIntegration { .. } => Span::empty(),
            Statement::AlterNotificationIntegration { .. } => Span::empty(),
            Statement::DropNotificationIntegration { .. } => Span::empty(),
            Statement::DescribeNotificationIntegration { .. } => Span::empty(),
            Statement::ShowNotificationIntegrations { .. } => Span::empty(),
            Statement::CreateExternalAccessIntegration { .. } => Span::empty(),
            Statement::AlterExternalAccessIntegration { .. } => Span::empty(),
            Statement::DropExternalAccessIntegration { .. } => Span::empty(),
            Statement::DescribeExternalAccessIntegration { .. } => Span::empty(),
            Statement::ShowExternalAccessIntegrations { .. } => Span::empty(),
